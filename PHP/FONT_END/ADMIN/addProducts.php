   ...
   include('../../ELEMENTS/topHeader.php');
    ...
    <div class="body-admin-page">
       ...
       ?>
                ...
                <form action="" method="post" >
                    <div class="form-add-products">
                        <div class="left-add-products-page">
                            ...
                            <div class="item-add">
                                <input type="text" id="nameProducts" name="nameProducts" onkeyup="getSlug()" class="item-input-add"
                                    placeholder="&nbsp;&nbsp;Name products (*)">
                                <input type="text" id="slugProducts" name="slugProducts" class="item-input-add"
                                    placeholder="&nbsp;&nbsp;Slug products (*)">
                            </div>
                            <div class="item-add">
                                <select name="categories" class="item-input-add">
                                    <?php 
                                ...
                                <select name="brands" class="item-input-add">
                                    <?php 
                            ...
                            <div class="item-add">
                                <input type="number" id="priceProducts" name="priceProducts" class="item-input-add"
                                    placeholder="&nbsp;&nbsp;Price (*)">
                            ...
                            <input type="file" id="image" name="image"
                                class="item-input-add-products image-add-products" placeholder="&nbsp;&nbsp;Image products">
                            <input type="file" id="listImage" name="listImage"
                                class="item-input-add-products image-add-products" placeholder="&nbsp;&nbsp;List image products">
                        </div>
            ...
            <button class="btn-add-products" name="btnAddProducts" id="btnAddProducts">Submit</button>
            </form>
        </div>
    </div>
    </div>
